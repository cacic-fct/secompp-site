<div class="container mx-auto sm:px-4">
  ...
  <div class="join join-vertical w-full">
    <div class="collapse join-item collapse-arrow border border-base-300">
      ...
      <div class="collapse-title text-base font-semibold">Quem pode participar?</div>
      <div class="collapse-content">
        Qualquer pessoa pode participar do evento, basta
        <a class="font-bold" href="https://fct-pp.web.app/eventos/eventos" target="_blank">
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Como realizo a minha inscrição?</div>
      <div class="collapse-content">
        ...
        <br />
        <br />
        3. Confira os minicursos selecionados e confirme;
        <br /> <br />
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Como realizo o pagamento?</div>
      <div class="collapse-content">
        ...
        <br />
        <br />
        <b>FUNDACTE - Fundação de Ciência Tecnologia e Ensino</b>
        <br />
        <b>Chave Pix (CNPJ):</b> 00.395.519/0001-16
        <br />
        <br />
        <b>Banco 033 - Santander</b>
        <br />
        <b>Agência:</b> 4299
        <br />
        ...
        <a class="font-bold" target="_blank" href="https://fct-pp.web.app/inscricoes/pagar/dViFyyJuepTPjcaZXfZa"
          >no site</a
        >.
        <br />
      </div>
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Haverá emissão de certificado de participação?</div>
      <div class="collapse-content">
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Há algum tipo de evento livre para participação?</div>
      <div class="collapse-content">
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Preciso trazer o notebook para os minicursos?</div>
      <div class="collapse-content">
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Haverá pausa para o café?</div>
      <div class="collapse-content">
    ...
    <div class="collapse-arrow collapse join-item border border-base-300">
      <input type="radio" name="my-accordion-4" />
      <div class="collapse-title text-base font-semibold">Haverá intervalo para o almoço?</div>
      <div class="collapse-content">
        <!-- TODO: Preencher horário-->
