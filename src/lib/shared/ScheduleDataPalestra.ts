...
const ScheduleData: ScheduleEventList = [
  createEvent('Computação em nuvem',
  'Auditório',
  1,
  new Date('2023-09-25T19:00'),
  150,
  'Computação em nuvem',
  '',
  ...
  createEvent('Introdução à containers',
  'Auditório',
  1,
  ...
  createEvent('Carreira em Ciência de dados',
  'Auditório',
  1,
