...
const ScheduleData: ScheduleEventList = [
  ...
  createEvent('Mesa-redonda: carreiras em computação', 'Auditório', 1, new Date('2023-09-28T19:00'), 150, 'Mesa-redonda', 'Carreiras e trajetórias', [
    { name: 'Caio Takeshi Onishi' },
    { name: 'Giulia Campos de Oliveira' },
    { name: 'Leandro Ungari Cayres' },
  ]),
];
