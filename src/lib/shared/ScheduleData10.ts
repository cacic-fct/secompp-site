...
const ScheduleData: ScheduleEventList = [
  ...
  createEvent('Introdução à Linguagem Python para Análise de Dados - parte 1',
  'Laboratório 10',
  0,
  ...
  createEvent('Introdução à Linguagem Python para Análise de Dados - parte 2',
  'Laboratório 10',
  0,
  ...
  {name:'Vinícius Polachini Mayer Freitas de Jesus',email:'vinicius.polachini@unesp.br'},]),
	...
	createEvent('Do zero ao Backend, com Javascript - parte 1',
  'Laboratório 10',
  0,
  ...
  createEvent('Git Simplificado - parte 2',
  'Laboratório 6',
  0,
